...
const LOVING_AFFIRMATIONS = [
  "יעלי אהובה, כל יום מקרב אותנו עוד צעד אל הידיים המלאות שלנו ❤️",
  "את גיבורה, חזקה ומופלאה. אני איתך בכל שנייה, בכל כדור ובכל בדיקה 💕",
  "נושמים עמוק, סומכים על הגוף שלך, והולכים יד ביד בכל התהליך הזה 🌸",
  "גאה בך כל כך על הסבלנות, העוצמה והאהבה הענקית שיש בך ✨",
  "המסע הזה הוא שלנו יחד. שולח לך חיבוק עוטף ומלא כוחות ליום הזה 🌿"
];
...
const DEFAULT_STAGES = [
  ...
  },
  {
    ...
    durationDays: 14,
    type: 'medication',
    description: 'כדורים / נרות לתמיכה ברירית ובהשתרשות',
    medicationId: 'med-4',
    color: 'emerald'
  }
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-rose-400 font-medium">מעקב זקיקים עוטף, אישי ומדויק</p>
            </div>
          </div>
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div>
                      <div className="inline-block bg-white/20 backdrop-blur-xs px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider mb-2">
                        שלום יעלי היקרה והאהובה שלנו ❤️
                      </div>
                        ...
                        {medications.map(med => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <button
                                onClick={() => sendWhatsAppReminder(med, med.hours[0])}
                                className="inline-flex items-center gap-1.5 text-xs bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-semibold px-2.5 py-1.5 rounded-lg border border-emerald-200 cursor-pointer transition"
                                title="שלח תזכורת בוואטסאפ ליעלי"
                              >
                                <span>💬</span>
                ...
                <div className="space-y-5">
                  {resolvedStages.map((stg, index) => {
                    ...
                    return (
                      <div
                        key={stg.id}
                        className={`relative flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 sm:p-5 rounded-2xl border transition-all ${
                          stg.isCurrent
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-12 h-12 rounded-2xl font-bold flex flex-col items-center justify-center text-xs shrink-0 shadow-xs ${
                              stg.isCurrent
                      ...
                      cells.push(
                        <div
                          ...
                          className={`min-h-[90px] sm:min-h-[110px] p-1.5 sm:p-2 transition flex flex-col justify-between ${
                            isToday ? 'bg-rose-50/80 ring-2 ring-rose-400 inset-0' : 'bg-white hover:bg-slate-50/60'
                          }`}
                        >
                          <div className="flex justify-between items-center mb-1">
                            <span
                              className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ${
                                isToday ? 'bg-rose-500 text-white shadow-2xs' : 'text-slate-700'
                              }`}
                            >
                              {day}
                            </span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                        <button
                          onClick={() => sendWhatsAppReminder(med, med.hours[0])}
                          className="w-full bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold py-2 rounded-xl transition flex items-center justify-center gap-2 shadow-2xs cursor-pointer"
                        >
                          <span>💬</span>
                          <span>שלח תזכורת מיידית לוואטסאפ</span>
                        </button>
                      </div>
                    </div>
                  );
